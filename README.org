...
* GitHub username: jackjeong98

trying out newbranch

* Notes:
I tried not touching the files that have been provided from you, the imagehelpers.h and imagehelpers.cpp in order to run it together
with the my own seperate file of funcs.h and funcs.cpp. However due to some linking issues, it failed. So I am combining all the codes together
into one file of imagehelpers.cpp with imagehelpers.h.
